  ...
  methods: {
    ...
    createPoints() {
      ...
      this.circles = d3
        ...
        .attr("r", function(d) {
          return vm.options.markerSize / vm.transform.scale;
        })
        .attr("fill", function(d) {
          return d.frame == vm.frame ? "white" : "black";
        })
        .attr("stroke", function(d) {
          return d.frame == vm.frame ? "black" : "white";
        })
        .attr("stroke-width", function(d) {
          return (0.4 * vm.options.markerSize) / vm.transform.scale;
        })
    ...
    createLines() {
      ...
      this.lines = d3
        ...
        .attr("stroke", function(d) {
          return d.target.frame > vm.frame ? "red" : "blue";
        });
    },
    updateLines() {
      var vm = this;
